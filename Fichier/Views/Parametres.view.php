...
<head>
    ...
    <link rel="stylesheet" href="assets/css/param_clients.css">
...
<div class="app-container">
    ...
    <aside class="sidebar">
        <div class="sidebar-top">
            <div class="logo-area">
                <img src="assets/img/Logo App.png" alt="Logo VTC" class="logo-img">
            ...
            <nav class="sidebar-nav">
                <ul>
                    <li>
                        <a href="#">
                            <img src="assets/img/dashboard.png" alt="Dashboard" class="nav-icon">
                            Tableau de bord
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="assets/img/wheel.png" alt="Véhicules" class="nav-icon">
                            Véhicules
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="assets/img/car.png" alt="Réservations" class="nav-icon">
                            Réservations
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="assets/img/calendar.png" alt="Calendrier" class="nav-icon">
                            Calendrier
                        </a>
                    </li>
                </ul>
        ...
        <div class="sidebar-bottom">
            <a href="#" class="nav-link active-settings">
                <img src="assets/img/paramètre.png" alt="Paramètres" class="nav-icon">
                Paramètres
            </a>
        </div>
    </aside>
    ...
    <div class="search-wrapper">
        <img src="assets/img/loupe.png" alt="Recherche" class="search-icon">
    ...
    <div class="user-actions">
        ...
        <div class="action-container">
            <button class="notif-btn" id="notif-btn">
                <img src="assets/img/cloche.png" alt="Notifications" class="icon-img">
            </button>
        ...
        <div class="action-container">
            <div class="user-profile" id="user-profile-btn">
                <img src="assets/img/Logo App.png" alt="Avatar" class="avatar-img" id="header-avatar">
            ...
            <div class="section-header">
                ...
                <form class="profile-form">
                    ...
                    <div class="form-grid">
                        <div class="input-group">
                            ...
                            <div class="input-icon-wrapper">
                                <img src="assets/img/home.png" alt="Maison" class="input-img">
                                <input type="text" value="<?php echo htmlspecialchars($user['ville'] . ', ' . $user['code_postal']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-icon-wrapper">
                                <img src="assets/img/home.png" alt="Adresse" class="input-img">
                                <input type="text" value="<?php echo htmlspecialchars($user['code_postal']); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-group full-width">
                        ...
                        <div class="input-icon-wrapper">
                            <img src="assets/img/mail.png" alt="Email" class="input-img">
                    ...
                    <div class="form-grid">
                        <div class="input-group">
                            ...
                            <div class="input-icon-wrapper">
                                <img src="assets/img/cake_birth.png" alt="Date" class="input-img">
                                <input type="text" value="<?php echo htmlspecialchars($user['date_naissance']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            <label>Genre</label>
                            <div class="input-icon-wrapper">
                                <img src="assets/img/man.png" alt="Genre" class="input-img">
                                <input type="text" value="<?php echo htmlspecialchars($user['genre']); ?>">
                    ...
                    <div class="photo-section">
                        ...
                        <div class="photo-preview">
                            <div class="avatar-circle">
                                <img src="assets/img/Logo App.png" alt="Logo VTC" class="preview-img" id="avatar-preview">
                            </div>
                        </div>
                ...
                <div id="content-email" class="tab-content">
                    ...
                    <form class="profile-form">
                        <div class="input-group full-width">
                            ...
                            <div class="input-icon-wrapper">
                                <img src="assets/img/mail.png" class="input-img">
