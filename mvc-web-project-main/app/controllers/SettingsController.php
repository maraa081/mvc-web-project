        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            elseif ($action === 'profil') {
                ...
                if (!empty($dobInput)) {
                    ...
                    $nowDate = new DateTime(); # date actuelle 
                ...
                if ($this->clientModel->updateFullInfo($userId, $dataToSave)) {
                    ...
                    if ($emailChanged) {
                        $this->sendEmailNotification(
                            ...
                            "Bonjour ". htmlspecialchars($currentUser['nom']) .",<br><br>Votre adresse email principale sur Rentium a bien été changée pour : <strong>" . $newEmail . "</strong>."
                        );
                    }
                }
            }
