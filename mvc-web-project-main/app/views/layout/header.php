...
<nav class="navbar">
    <div class="nav-container">
        ...
        <a href="<?= BASE_URL ?>/public/index.php?page=home" class="nav-logo">
            <img src="<?= BASE_URL ?>/assets/images/Logo App.png" alt="Logo VTC Rentium" class="logo-img">
        ...
        <div class="nav-buttons">
            ...
            <?php else: ?>
                ...
                <div class="user-info">
                    <div class="user-avatar" style="overflow: hidden;"> <?php if (!empty($user['avatar_url'])): ?>
