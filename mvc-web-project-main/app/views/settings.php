...
<style>
    /* Cache les éléments du layout standard pour cette page spécifique si nécessaire */
...
<div class="settings-wrapper">
    ...
    <div class="page-card">
        ...
        <div id="content-profil" class="tab-content <?= $activeTab === 'profil' ? 'active-content' : '' ?>">
            ...
            <form class="profile-form" id="profileForm" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <?php 
                                ...
                                $dateMinimale = date('Y-m-d', strtotime('-95 years'));
                            ?>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-icon-wrapper">
                            <img src="<?= BASE_URL ?>/assets/images/<?= ($client['genre'] ?? 'Homme') === 'Femme' ? 'woman.png' : 'man.png' ?>" 
                                 alt="Genre" class="input-img" id="genre-icon">
                            <select name="genre" id="genre-select" style="width: 100%; padding: 14px 15px 14px 45px; border: 1px solid #e5e7eb; border-radius: 8px; background-color: #fff; outline: none; cursor: pointer; height: auto;">
                ...
                <div class="photo-section">
                    ...
                    <div class="photo-preview">
                        <div class="avatar-circle">
                            ...
                            ?>
                            <img src="<?= $currentAvatar ?>" alt="Avatar" class="preview-img" id="avatar-preview" data-default-src="<?= $defaultAvatar ?>" style="object-fit:cover; width:100%; height:100%;">
                        </div>
                    </div>
                ...
                <div class="social-section">
                    <div class="social-label"><h3>Profils sociaux</h3></div>
        ...
        <div id="content-password" class="tab-content <?= $activeTab === 'password' ? 'active-content' : '' ?>">
            ...
            <form class="profile-form" method="POST" action="" id="settingsForm" novalidate>
                ...
                <div class="form-grid">
                    <div class="input-group">
                        ...
                        <div class="input-icon-wrapper plain-input">
                            <input type="password" name="new_password" id="input-new-pass" placeholder="8 caractères min.">
                        </div>
                        <small class="error-msg"></small>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-icon-wrapper plain-input">
                            <input type="password" name="confirm_password" id="input-confirm-pass" placeholder="Répéter le mot de passe">
                        </div>
                        <small class="error-msg"></small>
                    </div>
                </div>
        ...
        <div id="content-email" class="tab-content <?= $activeTab === 'email' ? 'active-content' : '' ?>">
            ...
            <form class="profile-form" method="POST" action="" id="emailForm">
                ...
                <div class="input-group full-width">
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <input type="email" name="email_main" id="input-email" value="<?= htmlspecialchars($client['email']) ?>">
                    </div>
                    <small class="error-msg"></small>
