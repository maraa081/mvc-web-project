...
(14, 'Mercedes Classe A – Confort et élégance', 'Mercedes Classe A idéale pour vos trajets urbains et professionnels.', '2025-12-19 02:04:27', 1, 1, NULL, 48.856600, 2.352200, 1),
(15, 'BMW Série 3 – Dynamisme et performance', 'BMW Série 3 parfaite pour une conduite sportive et confortable.', '2025-12-19 02:04:27', 1, 1, NULL, 48.856600, 2.352200, 2),
(16, 'Audi A4 – Élégance allemande', 'Audi A4 alliant confort, style et fiabilité.', '2025-12-19 02:04:27', 1, 1, NULL, 48.856600, 2.352200, 3),
(17, 'Tesla Model 3 – 100% électrique', 'Tesla Model 3 pour une expérience de conduite moderne et écologique.', '2025-12-19 02:04:27', 1, 1, NULL, 48.856600, 2.352200, 4),
(18, 'Toyota RAV4 – SUV polyvalent', 'Toyota RAV4 spacieux et idéal pour les longs trajets.', '2025-12-19 02:04:27', 1, 1, NULL, 48.856600, 2.352200, 5);
...
(42, 5, 1, 'like', '2026-01-11 21:47:48');
...
(1, 5, '', '0681525298', NULL, NULL, 1, 0, 'Paris', '75006', '2000-01-09', 'Femme', '', '', '', '');
...
--
ALTER TABLE `annonce`
  MODIFY `id_annonce` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `article_votes`
  MODIFY `id_vote` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
