...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 19 jan. 2026 à 11:05
...
INSERT INTO `concessionnaire` (`id_concess`, `nom`, `siret`, `adresse`, `email`, `latitude`, `longitude`) VALUES
(1, 'Concession Rentium Paris', NULL, '12 rue de la Location, Paris', 'contact@rentium.fr', 48.856600, 2.352200),
(2, 'Rentium Paris', NULL, '10 rue de Paris', 'contact@rentium.fr', 48.872000, 2.357000),
(3, 'renault', NULL, '123 rue le paix, 75001 Paris', 'rentiumvtc@gmail.com', 48.869000, 2.332200),
(4, 'BMW', NULL, '141 Rue des Pêchers, 78370 Plaisir', 'rentiumvtc@gmail.com', 48.799140, 1.951758);
...
INSERT INTO `user` (`id_user`, `nom`, `email`, `mot_de_passe`, `is_active`, `avatar_url`, `created_at`, `email_verified`, `email_token`, `role`, `remember_token`, `siret`) VALUES
(1, 'max', 'maximelazurka@gmail.com', '$2y$10$KDJ2GGK6kFs8ok8EX.6VBuYbfQ/T6PBBODX8uCHYq0bbF9HQfTeyC', 1, NULL, '2025-12-19 01:46:57', 1, NULL, 'client', NULL, NULL),
(2, 'dscwxc', 'mma@gmail.com', '$2y$10$qRsw5X0jdbbt1iSMg5qYH.vUY84.pa/ALNe2QWcn8vXBi2re3INHO', 1, NULL, '2025-12-19 02:06:10', 1, NULL, 'client', NULL, NULL),
(3, 'osa', 'osa@sa', '$2y$10$vmzrb1s/rkfSVUkqcowKcusp4JzJ7GIi0OJfG7qMuAARHqCeNvFrW', 1, NULL, '2025-12-19 09:33:13', 1, NULL, 'client', NULL, NULL),
(4, 'max', 'max@maxiem', '$2y$10$1G2qBsSMaz1Fc7h4ujRsY.KZ5MV7vd9DRoW4879dzJpQvXz7RuFUK', 1, NULL, '2025-12-19 10:44:07', 1, NULL, 'client', NULL, NULL),
(6, 'BMW', 'rentiumvtc@gmail.com', '$2y$10$NnV5vXFPBP4UJX.VlcTHbO/62sKpx2QZcxa7zEXhPZqv4LC/Ms6B6', 1, NULL, '2026-01-17 19:41:30', 1, NULL, 'concessionnaire', NULL, '34360644800060');
...
(6, 'CQ-654-HQ', 'Peugeot', '208', 'Citadine', 'Rouge', 29.00, 3, 'http://localhost/test/public/uploads/1768609186_peugeot_208.jpg'),
(8, 'BA-676-HG', 'Audi', 'RS3', 'Coupé', 'Blanc', 90.00, 3, 'uploads/1768674252_audi_rs3.jpg'),
(9, 'KG-987-TH', 'BMW', 'M2', 'Coupé', 'Noir', 120.00, 3, 'uploads/1768675050_bmw_m2.jpg');
...
ALTER TABLE `user`
  ...
  ADD UNIQUE KEY `unique_remember_token` (`remember_token`),
...
--
ALTER TABLE `concessionnaire`
  MODIFY `id_concess` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
